...
export default function LoginScreen() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0C] flex flex-col items-center justify-center p-4 font-sans text-slate-200">
      ...
      >
        <div className="bg-[#121214]/80 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 text-center overflow-hidden">
          ...
          <p className="text-slate-400 text-[15px] mb-10 leading-relaxed">
            Sign in to access your secure multi-agent debate environments and saved configurations.
          </p>

          <button 
            onClick={login}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-100 text-slate-900 px-6 py-3.5 rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] active:scale-[0.98]"
          >
